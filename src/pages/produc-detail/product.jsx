...
<div>
        <Link to="/" className="back-button">⬅ Orqaga</Link>
    ...
    <div className="img">
      ...
      <div className="detail-info">
        ...
        <div className="rating">{"⭐".repeat(Math.round(product.rating))}</div>
              ...
              <p className="new-price-2">{product.price.toLocaleString()} so'm</p>
    ...
    <div className="installment-container">
      ...
      <div className="installment-details">
        ...
        <p>
            <span className="price">{monthlyPayment.toLocaleString()} so'm</span>
        </p>
